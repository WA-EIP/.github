...
## 📋 Outline
1. [:rocket: How to Contribute](#how-to-contribute)
    - [:bricks: Creating a New Repository](#creating-a-new-repository)
...
3. [:white_check_mark: Best Practices Checklist](#best-practices-checklist)
